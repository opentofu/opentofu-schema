...
func v1_11_0_Functions() map[string]schema.FunctionSignature {
			...
			Params: []function.Parameter{
				{
					...
					Description: "`containing_prefix` must be given in CIDR notation, as defined in [RFC 4632 section 3.1](https://tools.ietf.org/html/rfc4632#section-3.1).",
					Type:        cty.String,
				},
				{
					Name:        "contained_ip_or_prefix",
					Description: "`contained_ip_or_prefix` is either an IP address or an address prefix given in CIDR notation.",
					Type:        cty.String,
				},
			},
			ReturnType:  cty.Bool,
